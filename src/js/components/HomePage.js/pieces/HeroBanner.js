...
<div class="hero-overlay">
 ...
 ${HeroMovieTitle}
  ...
  <p class="movie-desc">Jquery is rising from the grave. Can the hero with a box of <br>socks save the day?</p>
  ...
  <video class="hero-video" src="movie.mp4" autoplay loop playsinline muted></video>
</section>`;
